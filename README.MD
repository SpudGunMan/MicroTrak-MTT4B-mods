...
The MTT4BT makes PORT-A available either via (bluetooth OR 2.55mm stereo jack). Three 2.5mm jumpers on the MTT4BT PCB board select how PORTA is configured.
